...
public class Utils {
	...
	public static int[] iconNavigation = new int[] { 
		0, R.drawable.ic_action_about, R.drawable.ic_action_about, R.drawable.ic_action_about,
		R.drawable.ic_action_about, R.drawable.ic_action_about, 0, R.drawable.ic_action_about,
		R.drawable.ic_action_about, R.drawable.ic_action_about, 0, R.drawable.ic_action_map, R.drawable.ic_action_share};
