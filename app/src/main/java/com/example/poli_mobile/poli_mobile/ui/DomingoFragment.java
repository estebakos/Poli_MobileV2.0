...
public class DomingoFragment extends Fragment implements HorarioListener,
		OnRefreshListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		tvScheduleBackground = (TextView) v
				.findViewById(R.id.tvScheduleBackground);
		ivScheduleBackground = (ImageView) v
				.findViewById(R.id.ivScheduleBackground);
		callService();
	...
	public void callService() {
		WsHorario wshora = new WsHorario(ApplicationSession.SessionStudent, "Domingo");
	...
	public void HorarioListo(List<HorarioSemestreActual> lHorario) {
		if (lHorario.size() == 0) {
			...
			lvLunes.setAdapter(new HorarioAdapter(getActivity(),
					R.layout.horarioitem, lHorario));
		}
	}
